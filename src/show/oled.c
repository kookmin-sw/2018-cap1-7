...
{  
	...
	//From power to start the following initialization have enough time, that is waiting for completion of RC reset
  ...
  LCD_WrCmd(0xa1);//--Set SEG/Column Mapping     About 0xa0 inverted 0xa1 normal
  LCD_WrCmd(0xc8);//Set COM/Row Scan Direction   xc0 normal upper and lower inverted 0xc8
  ...
  LCD_Fill(0x00);  //The initial screen is cleared
  LCD_Set_Pos(0,0); 	
} 

//==============================================================
//Function name：LCD_P6x8Str(unsigned char x,unsigned char y,unsigned char *p)
//Description: write a standard ASCII string
//String position (x, y) is displayed, y is 0 to 7 page range to be displayed: Parameter
//Returns: None
//==============================================================  
...
//==============================================================
//Function name：LCD_P8x16Str(unsigned char x,unsigned char y,unsigned char *p)
//Description: write a standard ASCII string
//String position (x, y) is displayed, y is 0 to 7 page range to be displayed: Parameter
//Returns: None
//============================================================== 
...
//==============================================================
//Function name：LCD_P14x16Ch(unsigned char x,unsigned char y,unsigned char N)
//Description: Character string output
//String position (x, y) is displayed, y is 0 to 7 page range to be displayed: Parameter
//Returns: None
//============================================================== 
...
//==============================================================
//Function name： void Draw_BMP(byte x,byte y)
//Description: Display BMP picture 128 × 64
