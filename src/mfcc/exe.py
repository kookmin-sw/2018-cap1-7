...
from ceps import write_ceps, read_ceps

from saveToWav import record_sounds, WAV_DIR
...
if __name__ == "__main__":
	...
	train_avg, test_avg, cms ,clfss= train_model(create_model, X, y, "Log Reg CEPS", plot=True)
	
	wav_dir = "/home/viewtiful/바탕화면/2018-cap1-7/src" 
	
	while num < 30 :
		record_sounds("file", wavfile_num)
		os.chdir(wav_dir)
